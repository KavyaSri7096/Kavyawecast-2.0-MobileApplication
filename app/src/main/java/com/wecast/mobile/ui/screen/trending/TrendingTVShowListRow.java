...
public class TrendingTVShowListRow extends ListRowView<TVShow> {

    @Inject
    TVShowRepository tvShowRepository;

    public TrendingTVShowListRow(@NonNull Context context) {
        super(context);
    }

    public TrendingTVShowListRow(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TrendingTVShowListRow(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected String title() {
        return getContext().getResources().getString(R.string.top_tv_shows);
    }
    ...
    private void fetchData(int page) {
        Disposable disposable = tvShowRepository.getTrending(true)
