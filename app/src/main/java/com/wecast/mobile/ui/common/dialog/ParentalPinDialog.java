...
import com.wecast.mobile.databinding.DialogParentalPinBinding;
...
public class ParentalPinDialog extends BaseDialog {

    public static final String TAG = ParentalPinDialog.class.getName();

    @Inject
    PreferenceManager preferenceManager;

    private DialogParentalPinBinding binding;
    private OnPinInputListener onPinInputListener;

    public static ParentalPinDialog newInstance() {
        return new ParentalPinDialog();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.dialog_parental_pin, container, false);
    ...
    private void setupListeners() {
        binding.confirm.setOnClickListener(v -> {
            ...
            String currentPIN = preferenceManager.getPIN();
