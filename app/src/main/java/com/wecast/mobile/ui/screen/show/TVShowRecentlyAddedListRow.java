...
public class TVShowRecentlyAddedListRow extends ListRowView<TVShow> {

    @Inject
    TVShowRepository tvShowRepository;

    public TVShowRecentlyAddedListRow(@NonNull Context context) {
        super(context);
    }

    public TVShowRecentlyAddedListRow(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TVShowRecentlyAddedListRow(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void fetchData(int page) {
        Disposable disposable = tvShowRepository.getRecentlyAdded(true, page)
