...
public class HomeTVShowsListRow extends ListRowView<TVShow> {

    @Inject
    TVShowRepository tvShowRepository;

    public HomeTVShowsListRow(@NonNull Context context) {
        super(context);
    }

    public HomeTVShowsListRow(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public HomeTVShowsListRow(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected String title() {
        return getContext().getResources().getString(R.string.tv_shows);
    }
    ...
    private void fetchData(int page) {
        Disposable disposable = tvShowRepository.getAll(page > 1, page)
