...
public class HomeMoviesListRow extends ListRowView<Vod> {

    @Inject
    VodRepository vodRepository;

    public HomeMoviesListRow(@NonNull Context context) {
        super(context);
    }

    public HomeMoviesListRow(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public HomeMoviesListRow(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected String title() {
        return getContext().getResources().getString(R.string.movies);
    }
    ...
    private void fetchData(int page) {
        Disposable disposable = vodRepository.getAll(page > 1, page)
