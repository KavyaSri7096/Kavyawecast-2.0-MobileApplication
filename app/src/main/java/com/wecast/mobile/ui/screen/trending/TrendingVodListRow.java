...
public class TrendingVodListRow extends ListRowView<Vod> {

    @Inject
    VodRepository vodRepository;

    public TrendingVodListRow(@NonNull Context context) {
        super(context);
    }

    public TrendingVodListRow(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TrendingVodListRow(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected String title() {
        return getContext().getResources().getString(R.string.top_movies);
    }
    ...
    protected ListRowAdapter adapter() {
        return new ListRowAdapter(getContext(), ListRowType.MOVIES);
    }
    ...
    private void fetchData(int page) {
        Disposable disposable = vodRepository.getTrending(true)
