...
public class VideoQualityAdapter extends SingleChoiceAdapter<ChannelStreamingProfile, VideoQualityAdapter.VideoQualityViewHolder> {

    public VideoQualityAdapter(PreferenceManager preferenceManager, List<ChannelStreamingProfile> list, SingleChoiceAdapter.OnCheckListener<ChannelStreamingProfile> listener) {
    ...
    public class VideoQualityViewHolder extends SingleChoiceViewHolder<ChannelStreamingProfile> {
