...
public class VodPlayerAudioTrackDialog extends BaseDialog implements ItemSingleChoiceAdapter.OnCheckListener<WePlayerTrack> {
    ...
    private void setupUI() {
        ...
        binding.title.setText(getResources().getString(R.string.audio_profiles));
