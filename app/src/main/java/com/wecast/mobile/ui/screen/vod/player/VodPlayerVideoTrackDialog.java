...
public class VodPlayerVideoTrackDialog extends BaseDialog implements SingleChoiceAdapter.OnCheckListener<WePlayerTrack> {

    public static final String TAG = VodPlayerVideoTrackDialog.class.getName();
    ...
    private void setupUI() {
        ...
        binding.title.setText(getResources().getString(R.string.video_profiles));
        ...
        ArrayList<WePlayerTrack> data = trackSelector != null ? trackSelector.getVideoTracks() : new ArrayList<>();
